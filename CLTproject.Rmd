...
```
The standard deviation shrinks as the number gets higher example 4 is divided by 2, 9 is divided by 3. 16 divided by 4 and so on. The standard deviation is 'r not' The expected value is, the mean will always stay the same while the standard defiation will shrink. The numb is a demonstration of that happening. `r sd (my1000$k3)`
...
```
The standard deviation is now a quarter of what it was before by 10. We expect 10 and we get r sd (my1000$k4
the expected amount is slightly off from what was given.
...
```
We expect 8 and got r sd(my1000$k5) The standard deviation number shrinks with the numb value aswell.
...
```
we expect 6 and we gor 'r sd (my1000$k6) The expected value is slightly off and can be rounded to the nearest 7.
